...
logical FUNCTION Lebedev_compute(x,y,z,w,numberOfPoints)
  ...
  case default
     Lebedev_compute = .false.
     return 
  end select
  Lebedev_compute = .true.
END FUNCTION Lebedev_compute
