...
*/
void grid_init_cuda(BeckeGrid *grid, BeckeGridCUDA *grid_d);

/*
Free the memory used on the CUDA device.
*/
void grid_free_cuda(BeckeGridCUDA *grid);
...
*/
// double grid_integrate_cuda(System *sys, BeckeGrid *grid, double *rad, int nrad);
