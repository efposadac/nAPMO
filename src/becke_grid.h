...
Calculates the n_radial Gauss-Chebyshev quadrature and n_angular Lebedev quadrature points.
References:
...
Returns:
    output (double): The value of cell_function (eq. 13, Becke, 1988) at point ``r``
*/
