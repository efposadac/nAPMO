# file: test_psi_numeric_becke_He.py
# nAPMO package
...
def test_psi_numeric_becke_He(basis='STO-3G'):
    """
    test_psi_numeric_becke_He
    * Closed shell
    * Single center
    * Single orbital
    * GTO: -2.807784 (CCCBDB)
...
def analyse_psi(psi):
    ...
    E_o_B = psi.D.dot(psi.O).sum() + psi._pce
...
if __name__ == '__main__':
    ...
    #     energies.append(test_psi_numeric_becke_He(basis))
