# file: test_psi_numeric_becke_PsH.py
# nAPMO package
...
def test_psi_numeric_becke_PsH(basis="AUG-CC-PVTZ"):
    """
    test_psi_numeric_becke_PsH
    * APMO
    * GTO: -0.6662409
...
def psi_optimization(psi):
    ...
    while not converged:
        ...
        print("{0:>4d} {1:>18.14f} {2:>18.14f} {3:>18.14f} {4:>18.14f}".format(
            it, E_tot, E_diff, p._optimize.delta_e.sum(), p._optimize.delta_orb.sum()))
...
if __name__ == '__main__':
    ...
    #     energies.append(test_psi_numeric_becke_PsH(basis))
